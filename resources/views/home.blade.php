  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="d-flex align-items-center"><img src="assets/img/1.png" alt="Logo"><span>Kec. Tahunan, Kab. Jepara, Jawa Tengah</span></i>
        <i class="d-flex align-items-center ms-4"><img src="assets/img/2.png" alt="Logo"><span>+1 5589 55488 55</span></i>
        <i class="d-flex align-items-center ms-4"><img src="assets/img/3.png" alt="Logo"><a href="mailto:pantaitelukawur@gmail.com">pantaitelukawur@gmail.com</a></i>
      </div>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#spot">Spot Pantai</a></li>
          <li><a class="nav-link scrollto " href="#warung">Kuliner</a></li>
        ...
        <div class="col-lg-5 col-md-6 footer-links">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#spot">Spot Pantai</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#warung">Kuliner</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#wisata">Paket Wisata</a></li>
