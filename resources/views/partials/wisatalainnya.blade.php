        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto active " href="/wisatalain">Paket Wisata</a></li>
                                ...
                                <div class=" text-left p-4 wisata-item">
                                    <p class="sub">
                                        <i class="fa fa-map-marker-alt text-primary me-2"></i><strong>Tujuan
                                            Wisata:</strong>&nbsp;{{ $d->tujuan_wisata }}
                                    </p>
                                    <p class="sub">
                                        <i
                                            class="fas fa-clock text-primary me-2"></i><strong>Durasi:</strong>&nbsp;{{ $d->durasi }}
                                    </p>
                                    <p class="sub">
                                        <i
                                            class="fas fa-tags text-primary me-2"></i><strong>Harga:</strong>&nbsp;{{ formatRupiah($d->harga) }}
                                    </p>
                                </div>
